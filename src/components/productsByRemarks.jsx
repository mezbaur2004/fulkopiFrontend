...
const ProductsByRemarks = () => {
    ...
    const ProductList = useSelector((state) => state.products.ListByRemark || []);

    const fetchProducts = async (pageNumber = 1) => {
        try {
            setLoading(true);
            const paginationData = await productListByRemarks(remarks, pageNumber, 8);
    ...
    document.title = `Remarks: ${remarks} | FULKOPI`;
    ...
    return (
        <div className="container mt-4 mb-5">
            <h4 className="mb-3 text-muted">Showing products for: "{remarks}"</h4>
