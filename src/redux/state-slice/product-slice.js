...
export const {SetProductList, SetProductDetails, SetListByKeyword,SetListByRemark, SetListByBrand, SetListByCategory, SetBrandList, SetCategoryList}=productSlice.actions;
